    ...
    public function testGenerateSucceedsAndMatchesGoldenOutput(): void
    {
        ...
        try {
            ...
            if (getenv('UPDATE_GOLDENS') === '1') {
                // The golden is being regenerated by GoldenOutputTest in the
                // same run; comparing against the stale file would fail.
                return;
            }
            ...
            if (YamlDumpStyle::matchesGoldens()) {
                ...
                self::assertSame(
                    YamlDumpStyle::canonicalize((string) file_get_contents($case.'/expected.yaml')),
                    YamlDumpStyle::canonicalize((string) file_get_contents($tmp.'/out.yaml')),
